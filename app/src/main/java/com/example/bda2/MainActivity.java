...
import com.example.bda2.Adapter.UserAdapter;
import com.example.bda2.Model.User;
...
public class MainActivity extends AppCompatActivity
   ...
   private UserAdapter userAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Caring Youth");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (snapshot.hasChild("profilepictureurl")){
                        ...
                        nav_profile_image.setImageResource(R.drawable.main_profile);
                    }
                }
            }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.compatible:
                ...
                intent12.putExtra("group","Compatible with me");
            ...
            case R.id.about:
                ...
                break;
            case R.id.sentEmail:
                Intent intent11 = new Intent(MainActivity.this,EmailActivity.class);
